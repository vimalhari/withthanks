...
from . import views, views_campaign, views_clients, analytics_views, views_revenue, views_billing
...
urlpatterns = [
    ...
    path("update-job-fake-views/<int:job_id>/", views.update_job_fake_views, name="update_job_fake_views"),
    ...
    path("api/report/batch/<int:batch_id>/", views.batch_tracking_report, name="batch_tracking_report"),
    ...
    path("invoices/<uuid:invoice_id>/send-email/", views.invoice_send_email, name="invoice_send_email"),
    ...
    path("api/billing/services/", views_billing.ServiceCatalogAPI.as_view(), name="api_billing_services"),
    path("api/billing/services/<int:service_id>/", views_billing.ServiceCatalogAPI.as_view(), name="api_billing_services_detail"),
    path("api/billing/calculate/", views_billing.InvoiceCalculationAPI.as_view(), name="api_billing_calculate"),
    path("api/billing/create/", views_billing.CreateInvoiceAPI.as_view(), name="api_billing_create"),
    ...
    path("client-setup/manage-password/<int:user_id>/", views.manage_user_password, name="manage_user_password"),
    ...
    path("clients/<int:client_id>/campaign/", views_clients.client_campaign_redirect, name="client_campaign_redirect"),
    ...
    path("campaigns/<uuid:campaign_id>/fields/", views_campaign.campaign_fields, name="campaign_fields"),
    path("campaigns/<uuid:campaign_id>/fields/add/", views_campaign.campaign_field_add, name="campaign_field_add"),
    path("campaigns/<uuid:campaign_id>/fields/<int:field_id>/delete/", views_campaign.campaign_field_delete, name="campaign_field_delete"),
]
