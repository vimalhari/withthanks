...
def export_analytics_csv(data_list, filename, summary_stats=None):
    ...
    # 2. Detailed Headers
    writer.writerow(['Date', 'Campaign', 'Recipients', 'Delivered', 'Opened', 'Clicked', 'Plays', 'Avg Watch Time', 'Completion %'])
...
def export_analytics_excel(data_list, filename, summary_stats=None):
    ...
    # 2. Detailed Headers
    headers = ['Date', 'Campaign', 'Recipients', 'Delivered', 'Opened', 'Clicked', 'Plays', 'Avg Watch Time', 'Completion %']
    ...
    for col in range(3, 8):
        ...
        ws.cell(row=totals_row, column=col, value=f"=SUM({col_letter}{start_data_row}:{col_letter}{last_data_row})").font = bold_font
...
def export_batch_detail_csv(batch_info, data_list, filename):
    ...
    # Headers
    writer.writerow(['Recipient Name', 'Email', 'Type', 'Status', 'Real Hits', 'Simulated Views', 'Total Views', 'Watch Duration (s)', 'Bounce Reason'])
...
def export_batch_detail_excel(batch_info, data_list, filename, timeline_stats=None):
    ...
    headers = ['Recipient Name', 'Email', 'Type', 'Status', 'Real Hits', 'Simulated Views', 'Total Views', 'Watch Duration (s)', 'Bounce Reason']
    ws.append(headers)
