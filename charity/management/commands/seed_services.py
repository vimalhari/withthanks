...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        services = [
            # ADDITIONAL COSTS
            ("Email sign off", "ADDITIONAL", 50.00, "Standard email signature and sign-off processing."),
            ("Personalisation & voiceover amends", "ADDITIONAL", 55.00, "Custom voiceover updates and donor name matching."),
            ...
            ("Additional programming", "ADDITIONAL", 120.00, "Custom logic for campaign routing or data mapping."),
            ("Reformatting of data & clean up", "ADDITIONAL", 60.00, "Processing Excel/CSV files for video generation."),
            ("Client supplied audio clean up", "ADDITIONAL", 65.00, "Equalization and noise reduction for client audio."),
            ...
            ("Bounce back error log", "ADDITIONAL", 30.00, "Detailed email delivery failure report."),
            ("Additional donate page", "ADDITIONAL", 50.00, "Hosting and styling of supplementary landing page."),
            
            # VDM
            ("Video Direct Mail", "VDM", 575.00, "Full VDM campaign: outreach, stitches, audio, VO, and CTA."),
            ("Client supplied video/audio (VDM)", "VDM", 450.00, "VDM execution using client-provided media."),
