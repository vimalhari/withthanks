...
CHARITIES = [
    {
        ...
        "default_voiceover_script": (
            "Dear {{donor_name}}, thank you so much for your generous donation of "
            "£{{donation_amount}} to {{organization_name}}. Your support makes a real difference."
        ),
        "default_voice_id": "",
    },
    {
        ...
        "postcode": "M1 1AD",
        "default_voiceover_script": (
            "Hi {{donor_name}}, on behalf of everyone at {{organization_name}} — "
            "thank you for your amazing £{{donation_amount}} gift. You're changing lives."
        ),
        "default_voice_id": "",
    },
]
    ...
    "green_earth": [
        {
            ...
            "appeal_code": "GE-2025-SPR",
            "appeal_type": "WithThanks",
            "appeal_start": date(2025, 3, 1),
            "appeal_end": date(2025, 5, 31),
            "status": "closed",
            "description": "Spring fundraising appeal targeting regular donors.",
        },
        {
            "name": "Summer Giving 2025",
            "appeal_code": "GE-2025-SUM",
            "appeal_type": "WithThanks",
            "appeal_start": date(2025, 6, 1),
            "appeal_end": date(2025, 8, 31),
            "status": "active",
    ...
    "bright_futures": [
        {
            ...
            "appeal_code": "BF-2025-EDU",
            "appeal_type": "WithThanks",
            "appeal_start": date(2025, 1, 15),
            "appeal_end": date(2025, 6, 30),
            "status": "active",
            "description": "Annual education fund appeal.",
        },
        {
            "name": "VDM Outreach Q1",
            "appeal_code": "BF-2025-VDM",
            "appeal_type": "VDM",
            "appeal_start": date(2025, 1, 1),
            "appeal_end": date(2025, 3, 31),
            "status": "closed",
    ...
    def _create_campaign(self, charity: Charity, data: dict) -> Campaign:
        campaign, created = Campaign.objects.get_or_create(
            ...
            defaults={
                ...
                "appeal_start": data["appeal_start"],
                "appeal_end": data["appeal_end"],
                "status": data["status"],
