...
from .models_analytics import VideoEvent, CampaignStats
...
class CloudflareWebhookView(View):
    ...
    def post(self, request, *args, **kwargs):
        ...
        signature = request.headers.get('Webhook-Signature') or request.headers.get('Cf-Webhook-Signature')
        if settings.CLOUDFLARE_WEBHOOK_SECRET and not self.validate_signature(request.body, signature):
