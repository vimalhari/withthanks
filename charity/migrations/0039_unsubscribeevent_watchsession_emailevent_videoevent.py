    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            options={
                ...
                "indexes": [
                    models.Index(
                        fields=["event_type", "timestamp"], name="charity_ema_event_t_9d5fd5_idx"
                    ),
                    models.Index(fields=["job"], name="charity_ema_job_id_a64da0_idx"),
                    models.Index(fields=["campaign"], name="charity_ema_campaig_c4844f_idx"),
                ],
            },
        ),
        migrations.CreateModel(
            ...
            options={
                ...
                "indexes": [
                    models.Index(
                        fields=["event_type", "timestamp"], name="charity_vid_event_t_371d7a_idx"
                    ),
                    models.Index(fields=["job"], name="charity_vid_job_id_7a17c2_idx"),
                ],
            },
        ),
    ]
